...
export const caseStudiesData: CaseStudy[] = [
  {
    ...
    solution: 'bloomvers engineered an automated multi-region active-active cloud architecture on AWS using Terraform IaC, Amazon EKS, and Kafka event streams, supplemented with automated failover in under 4 seconds.',
    ...
    testimonial: {
      quote: 'bloomvers delivered what two previous consulting giants failed to do in 18 months. Our latency dropped immediately, and our auditors gave us top marks.',
      author: 'Marcus Vance',
  ...
  },
  {
    ...
    solution: 'bloomvers developed a private hybrid vector-search RAG engine powered by fine-tuned foundation models, military-grade field encryption, and human-in-the-loop validation dashboards.',
    ...
    testimonial: {
      quote: 'The AI platform built by bloomvers is nothing short of revolutionary for our research staff. It is blazing fast and flawlessly accurate.',
  ...
  },
  {
    ...
    solution: 'bloomvers replaced the monolithic CMS with a distributed headless Next.js edge-rendered storefront, Redis cluster caching, and autoscaling microservices on Google Cloud Platform.',
    ...
    testimonial: {
      quote: 'Our Black Friday sale generated record revenues without a single glitch or slowdown. bloomvers is our trusted strategic tech partner.',
      author: 'Sarah Chen',
  ...
  },
  {
    ...
    solution: 'bloomvers conducted comprehensive threat modeling, rolled out HashiCorp Vault secrets management, automated SAST/DAST container pipelines, and completed audit readiness in under 55 days.',
    ...
    testimonial: {
      quote: 'bloomvers got us enterprise audit-ready in half the time our internal team estimated. They are masters of modern cloud security.',
      author: 'David Kim',
