...
export const metadata: Metadata = {
  title: 'Contact Us | bloomvers',
  description: 'Get in touch with bloomvers. Reach our team for technical consultations, software development, cloud engineering, and general inquiries.',
};
